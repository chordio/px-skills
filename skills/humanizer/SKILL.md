...
description: |
  ...
  voice, negative parallelisms, empty intensifiers, and filler phrases.
license: MIT
...
### Don't manufacture slop while adding soul

Voice and edge are good, but they have failure modes. Even where this section applies, the push for personality can backfire into a different kind of slop. Two brakes:
...
**High-frequency AI words:** Actually, additionally, align with, crucial, delve, emphasizing, enduring, enhance, fostering, garner, highlight (verb), interplay, intricate/intricacies, key (adjective), landscape (abstract noun), pivotal, real, really, showcase, tapestry (abstract noun), testament, underscore (verb), valuable, vibrant
...
### 35. Standalone "What ..." Fragments

**Phrases to watch:** What measurement is worth., What it measures., What you get., What this unlocks. — any "What ..." clause punctuated as its own declarative sentence, most often a marketing heading or kicker.

**Problem:** The form garden-paths: the reader starts parsing a question and hits a period instead of an answer. It gestures at content rather than stating it, and it has become a stock marketing-copy move. The tell is the fragment — a "What ..." clause with no main clause completing it. ("What matters is the coverage" is a full sentence and fine; so is a real question the next sentence answers.)
...
- **"What ..." as the subject of a full sentence.** "What matters is the coverage" is complete and fine. The §35 tell is the fragment that ends where the main clause should begin.
...
4. Apply the regression lens: **"Did any edit make the text vaguer, more ambiguous, harder to read, or merely a different tic?"** (see "Don't trade one tell for another"). Answer briefly with any regressions.
5. Revise into a **final rewrite** that addresses both the remaining tells and the regressions, and contains no em or en dashes (see §14).

Deliver the draft, the brief "still-AI" bullets, the regression check, the final rewrite, and (optionally) a short summary of changes.
